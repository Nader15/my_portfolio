...
class MyProjects extends StatelessWidget {
      ...
      desktopScreen: Container(
        ...
        child: Column(
          children: [
            ...
            ...SYSTEM_PROJECTS
                .map((p) => _buildSystemProjects(context, p))
                .toList(),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(project.date!,style: TextStyle(color: Colors.white),),
                            )
                          ],
                        )
                      ],
  ...
  Widget _buildSystemProjects(BuildContext context, Project project) =>
      ResponsiveWidget(
        desktopScreen: SizedBox(
          width: MediaQuery.of(context).size.width * .7,
          child: Column(
